...
O objetivo é validar o fluxo completo de um e-commerce (Auth, Produtos, Carrinho e Usuários) garantindo integridade de dados e regras de negócio financeiras.
